...
units = [1]
options = options = [OptionClass.Option("docall",[S0, T, S0 * 0.95],0)]
...
N_MG_samples = 94 #int(n*(1/T)*2 - n + 1) # 5 years of data with n samples in T time.
overlap = False
n_MG_models = 1 
...
if save_output is True:
    text_file = open(folder_name + "output MG exp 2_{}, hedge points {}, tc = {}, samples = 2_{}, n MG samples = {}, same MG = {}, seed = {}, final act = {}, overlap = {}.txt".format(exp_nr,n,tc,N, N_MG_samples, use_same_MG, tmp_seed_bool, fi_ac_str, overlap),"w")
